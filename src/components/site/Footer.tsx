...
export function Footer() {
  return (
    <footer className="bg-card text-foreground border-t border-foreground/10 pt-32 pb-12 mt-0">
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid lg:grid-cols-[2fr_1fr_1fr_1fr] gap-12 pb-20">
          ...
          <div className="space-y-4">
            <p className="text-[10px] uppercase tracking-[0.25em] text-foreground/40">Library</p>
            <ul className="space-y-3 text-foreground/80">
              <li><Link to="/programs" className="hover:text-foreground hover:italic transition-all">Programs</Link></li>
          ...
          <div className="space-y-4">
            <p className="text-[10px] uppercase tracking-[0.25em] text-foreground/40">Studio</p>
            <ul className="space-y-3 text-foreground/80">
              ...
              <li><Link to="/login" className="hover:text-foreground hover:italic transition-all">Log in</Link></li>
            </ul>
          </div>
          <div className="space-y-4">
            <p className="text-[10px] uppercase tracking-[0.25em] text-foreground/40">Reach</p>
